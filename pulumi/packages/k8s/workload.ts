...
export interface ContainerOptions extends PartialKeys<raw.types.input.core.v1.Container, "name"> {
   ...
   */
  environmentSource?: pulumi.Input<ContainerEnvironmentSource>
...
export function mapWorkloadContainer(name: string, options: ContainerOptions) {
  return {
    ...
    envFrom: normalizeInputArrayAndMap(options.environmentSource, options.environmentSources, mapEnvironmentSource),
