...
export class StatefulSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apps.kruise.io/v1alpha1:StatefulSet';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.apps.v1alpha1.StatefulSetSpec | undefined>;
    /**
     * StatefulSetStatus defines the observed state of StatefulSet
     */
    public readonly status!: pulumi.Output<outputs.apps.v1alpha1.StatefulSetStatus | undefined>;
...
export interface StatefulSetArgs {
     ...
     * StatefulSetSpec defines the desired state of StatefulSet
     */
    spec?: pulumi.Input<inputs.apps.v1alpha1.StatefulSetSpecArgs>;
    /**
     * StatefulSetStatus defines the observed state of StatefulSet
     */
    status?: pulumi.Input<inputs.apps.v1alpha1.StatefulSetStatusArgs>;
}
