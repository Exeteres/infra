...
export class BackendTLSPolicy extends pulumi.CustomResource {
    ...
    public readonly apiVersion!: pulumi.Output<"gateway.networking.k8s.io/v1alpha3" | undefined>;
     ...
     */
    public readonly status!: pulumi.Output<outputs.gateway.v1alpha3.BackendTLSPolicyStatus | undefined>;
...
export interface BackendTLSPolicyArgs {
     ...
     * Spec defines the desired state of BackendTLSPolicy.
     */
    spec?: pulumi.Input<inputs.gateway.v1alpha3.BackendTLSPolicySpecArgs>;
    /**
     * Status defines the current state of BackendTLSPolicy.
     */
    status?: pulumi.Input<inputs.gateway.v1alpha3.BackendTLSPolicyStatusArgs>;
}
