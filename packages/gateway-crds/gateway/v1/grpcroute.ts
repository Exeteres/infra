...
export class GRPCRoute extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.gateway.v1.GRPCRouteSpec | undefined>;
    /**
     * Status defines the current state of GRPCRoute.
     */
    public readonly status!: pulumi.Output<outputs.gateway.v1.GRPCRouteStatus | undefined>;
...
export interface GRPCRouteArgs {
     ...
     * Spec defines the desired state of GRPCRoute.
     */
    spec?: pulumi.Input<inputs.gateway.v1.GRPCRouteSpecArgs>;
    /**
     * Status defines the current state of GRPCRoute.
     */
    status?: pulumi.Input<inputs.gateway.v1.GRPCRouteStatusArgs>;
}
