import { crds, createHelmRelease, createPasswordSecret, createRandomSecret, pulumi } from "@infra/core"
import { CommonAppOptions } from "../shared"
...
interface MailuAppOptions extends CommonAppOptions {
   ...
   */
  publicIssuer: crds.certmanager.v1.Issuer | crds.certmanager.v1.ClusterIssuer
}
